...
| `smashone-corp-linkedin-logo-400x400.png` | 400×400 | квадратный носитель: знак на 92 % высоты (22.09.2026; LinkedIn показывает логотип компании квадратом, поэтому не копия круглого аватара) — золотой знак `#b08930` на кремовом `#F7F6F2` (канон фавикона 25.08: чёрная плашка = дефект) |
